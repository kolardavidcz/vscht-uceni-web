    ...
    <div className="min-h-screen bg-brand-espresso text-slate-100 flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 max-w-6xl mx-auto px-4 py-16 sm:py-24 flex flex-col items-center justify-center relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full animate-[scale-in_0.35s_ease]">
          <Link to="/mikrobiologie" className="block h-full">
            <Card
              variant="dark"
              hover
              className="p-6 sm:p-8 group flex flex-col h-full relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-24 h-24 bg-brand-orange/5 rounded-full blur-2xl group-hover:bg-brand-orange/15 transition-all" />
          ...
          <Card
            ...
            className="p-6 sm:p-8 group flex flex-col h-full relative overflow-hidden"
          >
            <Link to="/obor-bioinformatika" className="absolute inset-0 z-0" aria-label="Obor Bioinformatika" />
            <div className="absolute top-0 right-0 w-24 h-24 bg-brand-orange/5 rounded-full blur-2xl group-hover:bg-brand-orange/15 transition-all" />
            <div className="p-4 bg-brand-orange/10 rounded-2xl text-brand-orange w-max border border-brand-orange/20 group-hover:scale-110 transition-transform relative z-10">
              <BookOpen size={24} />
            </div>
            <h2 className="font-display text-lg sm:text-xl font-black tracking-tight mt-6 mb-2 text-white group-hover:text-brand-orange transition-colors relative z-10">
              Obor: Bioinformatika
            </h2>
            <p className="text-xs sm:text-sm text-slate-400 font-medium leading-relaxed mb-3 flex-1 relative z-10">
            ...
            >
              <Link
                to="/obor-bioinformatika/1-semestr/bi-pa-1"
            ...
            <div className="flex items-center justify-between mt-auto border-t border-white/5 pt-4 text-[10px] sm:text-xs font-black tracking-wider text-brand-orange uppercase gap-2 relative z-10 pointer-events-none">
              <span className="flex items-center gap-1.5">
                <Binary size={14} />
                Markdown wiki
              </span>
          ...
          <Link to="/python-analyza" className="block h-full">
            <Card
              variant="dark"
              hover
              className="p-6 sm:p-8 group flex flex-col h-full relative overflow-hidden"
