# 0 · Během semestru a před ním

Vítejte v kurzu **Programování a algoritmizace I (BI-PA1)** na FIT ČVUT!  
Tento přehled shrnuje to podstatné: co udělat před semestrem, jak rozvrhnout síly během něj a jak projít bez zbytečného stresu.
...
## 🧭 Rozcestník kapitol BI-PA1

1. **[1 · WSL a setup](/obor-bioinformatika/1-semestr/bi-pa1/wsl-a-setup)** — Nastavení Linuxu ve Windows, instalace překladače a zářijový instalační den na FITu.
2. **[2 · Kalendář co musím umět](/obor-bioinformatika/1-semestr/bi-pa1/kalendar)** — Přehled témat týden po týdnu: co je těžké, jaké jsou pasty a co procvičit.
3. **[3 · Jak to spravit](/obor-bioinformatika/1-semestr/bi-pa1/jak-to-spravit)** — Ladění chyb kompilátoru, debugování výstupu, práce s pamětí a lokální testovací skript.
4. **[4 · Struktura kódu](/obor-bioinformatika/1-semestr/bi-pa1/struktura-kodu)** — Jak psát čistý, rozdělený kód do funkcí, aby se dal snadno debugovat.
5. **[5 · Progtest a zkouška](/obor-bioinformatika/1-semestr/bi-pa1/progtest-a-zkouska)** — Strategie nápověd, testování mezních stavů, antiplagiátor a tipy ke zkoušce.
